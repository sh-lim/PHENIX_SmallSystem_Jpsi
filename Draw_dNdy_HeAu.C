...
void Draw_dNdy_HeAu(){
	...
	double sys_trigeff[ncent+1][narm] = {0.}; //will be updated later
	...
	TFile *infile = new TFile("/gpfs/mnt/gpfs02/phenix/hhj/hhj1/shlim/work/15.run15/10.runQA/00.eventhist/Run14HeAu200_eventhist_for_dimuon_20180314.root","read");
	...
	for (int icent=0; icent<ncent+1; icent++){
		...
		TFile *infile1 = new TFile(Form("/gpfs/mnt/gpfs02/phenix/hhj/hhj1/shlim/work/15.run15/14.acc_by_eff/01.Inclusive_Jpsi/eff_files/Run14HeAu200_CENT%02d%02d_acceff_InclusiveJpsi_B.root",cent_perv2[icent],cent_perv2[icent+1]),"read");
		TFile *infile1_A = new TFile(Form("/gpfs/mnt/gpfs02/phenix/hhj/hhj1/shlim/work/15.run15/14.acc_by_eff/01.Inclusive_Jpsi/eff_files/Run14HeAu200_CENT%02d%02d_acceff_InclusiveJpsi_A.root",cent_perv2[icent],cent_perv2[icent+1]),"read");
	...
	for (int icent=0; icent<ncent+1; icent++){
		...
		TFile *infile2 = new TFile(Form("/gpfs/mnt/gpfs02/phenix/hhj/hhj1/shlim/work/15.run15/14.acc_by_eff/01.Inclusive_Jpsi/eff_files/Run14HeAu200_CENT%02d%02d_B_trigeff_MUID2D_output.root",cent_perv2[icent],cent_perv2[icent+1]),"read");
		TFile *infile2_A = new TFile(Form("/gpfs/mnt/gpfs02/phenix/hhj/hhj1/shlim/work/15.run15/14.acc_by_eff/01.Inclusive_Jpsi/eff_files/Run14HeAu200_CENT%02d%02d_A_trigeff_MUID2D_output.root",cent_perv2[icent],cent_perv2[icent+1]),"read");
	...
	for (int icent=0; icent<ncent; icent++){
		...
		{
			TLegend *leg = new TLegend(0.30,0.70,0.9,0.90);
			leg->SetFillStyle(0);
			leg->SetBorderSize(0);
			le = leg->AddEntry("","^{3}He+Au #sqrt{s_{NN}}=200 GeV","");
			le->SetTextSize(0.07);
